...
if(!class_exists('EasyFullscreenSliderPortfolioSettings')){
    class EasyFullscreenSliderPortfolioSettings
    {
        /**
        ...
        */
        ...
        public function __construct(){
            // register actions
            add_action('add_meta_boxes', array('portfolio', 'efs_register_meta_box'));
            add_action('save_post', array('portfolio' , 'efs_save_portfolio'));//TO DO
        }
        ...
        public function efslider_meta_box($post){
            ...
            require_once(plugin_dir_path( __FILE__ ).'templates/settings_portfolio.php');
        }
        public function efs_save_portfolio($post_id = false, $post_type = 'portfolio'){
            ...
            update_post_meta( $post_type, 'efslider', $values);
        }
    }
}
